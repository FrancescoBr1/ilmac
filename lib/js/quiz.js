...
function Quiz(vars) {
    ...
    if (xmlAttrStr(settings, "timer")) {
        this._timer = Boolean(xmlAttrStr(settings, "timer").toLowerCase() === "true");
    }
...
Quiz.prototype = {
    ...
    loadQuestion: function (id) {
        ...
        var loader = new ElementLoader({
            screen: this._screen,
            elements: array,
            onLoadComplete: "questionLoadComplete",
            onAnimsComplete: "questionAnimsComplete",
    ...
    jumpToEnd: function (element) {
        ...
        for ($i = this._iCurQ++; $i < this._arQs.length -1; $i++) {
    ...
    jumpToEndPopUp: function (element) {


        swal({
            title: "Attenzione",
            text: "Consegnando ora il test, riceveremo solo le risposte che hai dato fino a questo momento, vuoi davvero consegnare ora?",
            icon: "warning",
            ...
            buttons: {
                cancel: {
                    ...
                    value: false,
                    visible: true,
                    className: "btn btn-std btn__blu2",
                ...
                confirm: {
                    ...
                    value: true,
                    visible: true,
                    className: "btn btn-std btn__arancio",
    ...
    pass: function (score) {
        ...
        var submitBtn = get("btn");
        var quizfooter = document.getElementById("quiz_footer");
        var close = document.getElementById("close");
        var tit = document.getElementById("titolo2");
        tit.innerHTML = "Compila il form per ricevere la valutazione del nostro insegnante <br>";
        $("#titolo2").after("<p>*campo obbligatorio</p>");
    ...
    fail: function (score) {
        ...
        var tit = document.getElementById("titolo2");
        tit.innerHTML = "Compila il form per ricevere la valutazione del nostro insegnante <br>";
        $("#titolo2").after("<p id='o_camp'>*campo obbligatorio</p>");
    ...
    updateFooterBar: function () {
        ...
        if (footer) {
            ...
            if (page) {
                $(page._container).html("<p>Domanda: " + (this._iCurQ + 1) + "/" + this._arQs.length + "</p>");
            }
            footer._anim = "show";
            footer.animate();
        }
    ...
    sendResultJSON: function () {
        ...
        var cognome = document.getElementById("userLastName").value;
        var city = document.getElementById("userCity").value;
        var tele = document.getElementById("userTel").value;
        ...
        var tit = document.getElementById("titolo2");
        var o_camp = document.getElementById("o_camp");

        spinner.style.display = "inline-block";
        fc1.style.display = "none";
        fc2.style.display = "none";
        fc3.style.display = "none";
        fc4.style.display = "none";
        fc5.style.display = "none";
        fc6.style.display = "none";
        btn.style.display = "none";
        tit.style.display = "none";
        o_camp.style.display = "none";
    ...
    successFunc: function (response) {
        ...
        var sec_test = document.getElementById("test_section");
        if (sec_test)
            sec_test.style.display = "none";

        var sec_cta = document.getElementById("cta_section");
        if (sec_cta)
            sec_cta.style.display = "block";
        ...
        //wehay
        var tit = document.getElementById("titolo");
        tit.innerHTML = "Grazie per aver effettuato il test,sarai contattato entro 48 ore";
        var spinner = document.getElementById("spinner");
        if (spinner)
            spinner.style.display = "none";
